            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo site_url('utilities-color'); ?>">Colors</a>
                        <a class="collapse-item" href="<?php echo site_url('utilities-border'); ?>">Borders</a>
                        <a class="collapse-item" href="<?php echo site_url('utilities-animation'); ?>">Animations</a>
                        <a class="collapse-item" href="<?php echo site_url('utilities-other'); ?>">Other</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?php echo site_url('blank'); ?>">Blank Page</a>
                    </div>
                </div>
            </li>
