<footer class='bg' id='footer-wrapper'>
            <div class='lay'>
                <div id='outer-wrapper'>
                    <div class='boxwrap-text section' id='boxwrap-text' name='Logo & Maps'>
                            ...
                            <div class='widget HTML' data-version='2' id='HTML7'>
                                ...
                                <div class='widget-content'>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="https://www.kominfo.go.id/">Kemenkominfo</a>
                                        </li>
                                        <li>
                                            <a href="https://bssn.go.id/">BSSN</a>
                                        </li>
                                        <li>
                                            <a href="https://brin.go.id/">BRIN</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
